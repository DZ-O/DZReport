...
public class CsvTableGenerator extends FileGeneratorAbstact {
    ...
    public String[] generateSQL(File file, UploadRequest uploadRequest) throws Exception {
        ...
        List<String> insertSQLs = generateInsertSQLs(file, charset, uploadRequest.getDbTable(), columns);
    ...
    private List<String> generateInsertSQLs(File file, Charset charset, String tableName, List<ColumnDefinition> columns) throws IOException {
